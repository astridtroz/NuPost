...
def post_share(request, post_id):
    ...
    if request.method == 'POST':
        ...
        form = EmailPostForm()  # This should be outside the form.is_valid() block
...
def post_comment(request, post_id):
    ...
    comment=None #initialised a comment object to store incoming comment

    form= CommentForm(data=request.POST) #when a comment is posted form is filled
    if form.is_valid():
        #create a comment object to save the comment posted
